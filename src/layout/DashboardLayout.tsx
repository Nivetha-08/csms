...
const DashboardLayout = () => {
  ...
  const menuItems = [
    { label: "Dashboard", path: "/dashboard", icon: <IoHome />, roles: ["admin", "teacher"] },
    { label: "Students", path: "/student", icon: <FaPeopleGroup />, roles: ["admin", "teacher"] },
    { label: "Documents", path: "/documentgen", icon: <FaPeopleArrows />, roles: ["admin", "teacher"] },
    { label: "Marks", path: "/marks", icon: <BsBorderStyle />, roles: ["admin", "teacher"] },
    { label: "Fees", path: "/fees", icon: <FaPeopleCarryBox />, roles: ["admin", "teacher"] },
    { label: "Users", path: "/user", icon: <RiUserSettingsFill />, roles: ["admin"] },
  ]
    ...
    <div className="d-flex min-vh-100">
      ...
      {!isMobile && (
        ...
        >
          <div className="d-flex align-items-center justify-content-between p-3">
            {!collapsed && <h6 className="fw-bold text-primary mb-0">CRM</h6>}
            <button
      ...
      <div className="flex-grow-1 d-flex flex-column">
        ...
        <nav className="navbar bg-white border-bottom px-3 d-flex justify-content-between">
          ...
          <span className="fw-bold text-primary">College Student Management System Dashboard</span>
          <UserButton />
        </nav>
      ...
      >
        <div className="offcanvas-header">
          <h5 className="text-primary">CRM</h5>
